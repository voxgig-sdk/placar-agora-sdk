# PlacarAgora SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PlacarAgoraSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PlacarAgoraSDK(...) and PlacarAgoraSDK.test(...) become
#      PlacarAgoraSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "placaragora_sdk"
_SDK_CLASS = "PlacarAgoraSDK"
