...
from placaragora_sdk.core.helpers import get_ctx_prop, to_map
...
class PlacarAgoraContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, PlacarAgoraSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, PlacarAgoraResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PlacarAgoraResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return PlacarAgoraError(code, msg, self)
