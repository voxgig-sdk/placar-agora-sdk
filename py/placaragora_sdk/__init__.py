...
from placaragora_sdk.utility import register

# Load features
from placaragora_sdk.feature.base_feature import PlacarAgoraBaseFeature
from placaragora_sdk.features import _has_feature, _make_feature
...
class PlacarAgoraSDK:
    ...
    def get_utility(self):
        return PlacarAgoraUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PlacarAgoraSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Schedule(self, data=None) -> "ScheduleEntity":
        ...
        from placaragora_sdk.entity.schedule_entity import ScheduleEntity
        return ScheduleEntity(self, data)


    def Score(self, data=None) -> "ScoreEntity":
        """Entity factory: client.Score().list() / client.Score().load({"id": ...})."""
        from placaragora_sdk.entity.score_entity import ScoreEntity
        return ScoreEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "PlacarAgoraSDK":
        if sdkopts is None:
            sdkopts = {}
