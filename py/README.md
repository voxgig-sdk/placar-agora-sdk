# PlacarAgora Python SDK



The Python SDK for the PlacarAgora API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/placar-agora-sdk/releases)) or
...
```python
client = PlacarAgoraSDK.test(testopts, sdkopts)
```
...
```
py/
├── placaragora_sdk.py         -- Main SDK module
...
The main module (`placaragora_sdk`) exports the SDK class.
