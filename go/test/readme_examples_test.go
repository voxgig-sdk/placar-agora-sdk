...
const testSeed = `map[string]any{"entity": map[string]any{"schedule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "score": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
