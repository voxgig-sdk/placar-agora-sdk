...
func (sdk *PlacarAgoraSDK) OptionsMap() map[string]any {
...
func (sdk *PlacarAgoraSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *PlacarAgoraSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *PlacarAgoraSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PlacarAgoraSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *PlacarAgoraSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *PlacarAgoraSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("PlacarAgoraSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *PlacarAgoraSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PlacarAgoraSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("PlacarAgoraSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
