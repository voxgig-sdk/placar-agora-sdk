...
func NewScoreEntity(client *core.PlacarAgoraSDK, entopts map[string]any) *ScoreEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ScoreEntity) GetName() string { return e.name }
...
func (e *ScoreEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ScoreEntity) Deleted() bool {
	return e.deleted
}


func (e *ScoreEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewScoreEntity(e.client, opts)
}

func (e *ScoreEntity) Data(args ...any) any {
...
func (e *ScoreEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Score; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ScoreEntity) DataTyped(data ...Score) Score {
	if len(data) > 0 {
		return typedFrom[Score](e.Data(asMap(data[0])))
	}
	return typedFrom[Score](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Score (all fields
// optional at the wire level).
func (e *ScoreEntity) MatchTyped(match ...Score) Score {
	if len(match) > 0 {
		return typedFrom[Score](e.Match(asMap(match[0])))
	}
	return typedFrom[Score](e.Match())
}
...
func (e *ScoreEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ScoreEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ScoreEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ScoreListMatch and returns []Score. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ScoreEntity) ListTyped(reqmatch ScoreListMatch, ctrl map[string]any) ([]Score, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Score](res), nil
}



func (e *ScoreEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ScoreEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ScoreEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ScoreEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
