// Command PlacarAgora-mcp is an MCP server exposing the PlacarAgora
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PlacarAgora_list  — list records of an entity
//	PlacarAgora_load  — load a single record of an entity
//
