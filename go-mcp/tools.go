...
type Args struct {
	Entity string         `json:"entity" jsonschema:"schedule | score"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PlacarAgoraSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "placar-agora_list",
		Description: "List records from PlacarAgora. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "placar-agora_load",
		Description: "Load a single record from PlacarAgora. " +
...
func runOp(client *sdk.PlacarAgoraSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PlacarAgoraSDK, name string) (sdk.PlacarAgoraEntity, error) {
	switch strings.ToLower(name) {
	case "schedule":
		return client.Schedule(nil), nil
	case "score":
		return client.Score(nil), nil
