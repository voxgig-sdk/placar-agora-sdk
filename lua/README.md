...
The Lua SDK for the PlacarAgora API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/placar-agora-sdk/releases)),
...
```
lua/
├── placar-agora_sdk.lua    -- Main SDK module
...
The main module (`placar-agora_sdk`) exports the SDK constructor
