...
describe("ScoreDirect", function()
  it("should direct-list-score", function()
    local setup = score_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-score", setup.live and "live" or "unit")
...
function score_direct_setup(mockres)
