...
describe("ScheduleEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set PLACARAGORA_TEST_SCHEDULE_ENTID JSON to run live")
      return
    end
...
function schedule_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("PLACARAGORA_TEST_SCHEDULE_ENTID")
