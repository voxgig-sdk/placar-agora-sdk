...
function runner.env_override(m)
  local live = runner.getenv("PLACARAGORA_TEST_LIVE")
  local override = runner.getenv("PLACARAGORA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PLACARAGORA_TEST_EXPLAIN")
