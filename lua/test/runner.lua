...
function runner.env_override(m)
  local live = runner.getenv("PLACAR_AGORA_TEST_LIVE")
  local override = runner.getenv("PLACAR_AGORA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PLACAR_AGORA_TEST_EXPLAIN")
