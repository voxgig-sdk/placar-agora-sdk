...
|---|---|---|
| `ts/` | @voxgig-sdk/placar-agora-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/placar-agora-sdk \
      --repository voxgig-sdk/placar-agora-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/placar-agora-sdk` shows it, and
`npm trust revoke @voxgig-sdk/placar-agora-sdk --id=<id>` removes it.
