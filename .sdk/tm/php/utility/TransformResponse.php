...
// PlacarAgora SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class PlacarAgoraTransformResponse
{
    public static function call(PlacarAgoraContext $ctx): mixed
    {
        ...
        $transform = PlacarAgoraHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
