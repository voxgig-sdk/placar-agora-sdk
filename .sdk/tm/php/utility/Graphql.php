...
// PlacarAgora SDK utility: graphql
//
...
class PlacarAgoraGraphql
{
    ...
    // equivalent.
    public static function body(PlacarAgoraContext $ctx): mixed
    {
    ...
    public static function errors(PlacarAgoraContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
