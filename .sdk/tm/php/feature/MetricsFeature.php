...
// PlacarAgora SDK metrics feature
...
class PlacarAgoraMetricsFeature extends PlacarAgoraBaseFeature
{
    ...
    private function _record(PlacarAgoraContext $ctx, bool $ok): void
    {
