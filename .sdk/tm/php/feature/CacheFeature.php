...
class PlacarAgoraCacheFeature extends PlacarAgoraBaseFeature
{
    ...
    private function _through(PlacarAgoraContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
