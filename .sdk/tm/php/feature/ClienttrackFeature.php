...
// PlacarAgora SDK clienttrack feature
...
class PlacarAgoraClienttrackFeature extends PlacarAgoraBaseFeature
{
    ...
    public function PostConstruct(PlacarAgoraContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PlacarAgora-SDK';
