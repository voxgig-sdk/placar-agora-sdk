...
// PlacarAgora SDK netsim feature
...
class PlacarAgoraNetsimFeature extends PlacarAgoraBaseFeature
{
    ...
    private function _simulate(PlacarAgoraContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PlacarAgoraContext $ctx, array $applied): void
    {
        $client = $this->client;
