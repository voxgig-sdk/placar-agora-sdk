...
// PlacarAgora SDK ratelimit feature
...
class PlacarAgoraRatelimitFeature extends PlacarAgoraBaseFeature
{
    ...
    private function _acquire(PlacarAgoraContext $ctx): void
    {
    ...
    private function _track(PlacarAgoraContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
