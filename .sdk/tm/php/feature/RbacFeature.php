...
class PlacarAgoraRbacFeature extends PlacarAgoraBaseFeature
{
    ...
    private function _required(PlacarAgoraContext $ctx): ?string
    {
    ...
    private function _reject(PlacarAgoraContext $ctx, string $required): void
    {
    ...
    private function _track(PlacarAgoraContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
