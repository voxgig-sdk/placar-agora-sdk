...
// PlacarAgora SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PlacarAgoraOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PlacarAgoraOmni::structfix($now, Struct::undef()))
                        !== json_encode(PlacarAgoraOmni::structfix($val, Struct::undef()))) {
