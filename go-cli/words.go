...
func registerSDKWords(r *eng.Registry, client *sdk.PlacarAgoraSDK) {
...
func runOp(client *sdk.PlacarAgoraSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
