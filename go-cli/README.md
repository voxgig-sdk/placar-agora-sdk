...
AQL-driven CLI and REPL for the PlacarAgora SDK. Positional arguments are
...
./placar-agora-cli load 1 schedule
./placar-agora-cli load '{id:1}' schedule
