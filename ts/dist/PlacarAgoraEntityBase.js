...
exports.PlacarAgoraEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends PlacarAgoraEntityBase<Advice>`.
class PlacarAgoraEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.PlacarAgoraEntityBase = PlacarAgoraEntityBase;
//# sourceMappingURL=PlacarAgoraEntityBase.js.map