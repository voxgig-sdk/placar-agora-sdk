# PlacarAgora TypeScript SDK

The TypeScript SDK for the PlacarAgora API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| `tester(testopts?, sdkopts?)` | `PlacarAgoraSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `PlacarAgoraSDK.test(testopts?, sdkopts?)` | `PlacarAgoraSDK` | Create a test-mode client. |
...
placar-agora/
├── src/
│   ├── PlacarAgoraSDK.ts        # Main SDK class
