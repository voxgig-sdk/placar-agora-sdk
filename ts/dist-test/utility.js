...
function envOverride(m) {
    if ('TRUE' === process.env.PLACAR_AGORA_TEST_LIVE ||
        'TRUE' === process.env.PLACAR_AGORA_TEST_OVERRIDE) {
    ...
    m.PLACAR_AGORA_TEST_EXPLAIN = process.env.PLACAR_AGORA_TEST_EXPLAIN || m.PLACAR_AGORA_TEST_EXPLAIN;
    return m;
}
