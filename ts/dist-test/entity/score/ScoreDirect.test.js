...
(0, node_test_1.describe)('ScoreDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.PlacarAgoraSDK({
    ...
    (0, node_test_1.test)('direct-list-score', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-score', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.PLACAR_AGORA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PlacarAgoraSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['PLACAR_AGORA_TEST_SCORE_ENTID'];
    ...
    const client = new __1.PlacarAgoraSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ScoreDirect.test.js.map