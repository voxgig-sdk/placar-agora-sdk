...
#      offline in seeded test mode (PlacarAgoraSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "PlacarAgora_sdk.rb")
  SDK_CLASS = "PlacarAgoraSDK"
