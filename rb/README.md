# PlacarAgora Ruby SDK



The Ruby SDK for the PlacarAgora API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `PlacarAgoraError` (a `StandardError` subclass), so wrap
...
```
rb/
├── PlacarAgora_sdk.rb       -- Main SDK module
