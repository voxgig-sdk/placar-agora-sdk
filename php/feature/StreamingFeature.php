...
// PlacarAgora SDK streaming feature
...
class PlacarAgoraStreamingFeature extends PlacarAgoraBaseFeature
{
    ...
    private function _iterate(PlacarAgoraResult $result): \Generator
    {
    ...
    private function _streamable(PlacarAgoraContext $ctx): bool
    {
