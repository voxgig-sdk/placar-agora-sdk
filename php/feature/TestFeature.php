...
// PlacarAgora SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PlacarAgoraTestFeature extends PlacarAgoraBaseFeature
{
    ...
    public function init(PlacarAgoraContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PlacarAgoraContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = PlacarAgoraParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PlacarAgoraContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PlacarAgoraContext $ctx, $op, $args): array
    {
