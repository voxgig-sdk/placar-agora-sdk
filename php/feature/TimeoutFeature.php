...
// PlacarAgora SDK timeout feature
...
class PlacarAgoraTimeoutFeature extends PlacarAgoraBaseFeature
{
    ...
    private function _with_timeout(PlacarAgoraContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PlacarAgoraContext $_ctx, float $ms): void
    {
        $client = $this->client;
