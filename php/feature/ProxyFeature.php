...
class PlacarAgoraProxyFeature extends PlacarAgoraBaseFeature
{
    ...
    public function init(PlacarAgoraContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PlacarAgoraContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
