...
// PlacarAgora SDK idempotency feature
...
class PlacarAgoraIdempotencyFeature extends PlacarAgoraBaseFeature
{
    ...
    private function _mutating(PlacarAgoraContext $ctx): bool
    {
