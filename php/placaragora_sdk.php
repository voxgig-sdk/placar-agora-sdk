...
class PlacarAgoraSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = PlacarAgoraHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = PlacarAgoraHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!PlacarAgoraFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, PlacarAgoraFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return PlacarAgoraUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = PlacarAgoraHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = PlacarAgoraHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = PlacarAgoraHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new PlacarAgoraError($op . "_allow",
                "PlacarAgoraSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = PlacarAgoraHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new PlacarAgoraError("graphql_error",
                "PlacarAgoraSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Score($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_score === null) {
                $this->_score = new ScoreEntity($this, null);
            }
            return $this->_score;
        }
        return new ScoreEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new PlacarAgoraSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
