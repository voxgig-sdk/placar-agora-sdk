...
// PlacarAgora SDK utility: fetcher

class PlacarAgoraFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PlacarAgoraSDK/1.0)';
    ...
    public static function call(PlacarAgoraContext $ctx, string $fullurl, array $fetchdef): array
    {
