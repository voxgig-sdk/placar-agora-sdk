...
class ScoreDirectTest extends TestCase
{
    public function test_direct_list_score(): void
    {
        $setup = score_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-score", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
