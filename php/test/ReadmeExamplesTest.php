...
// PlacarAgora SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PlacarAgoraSDK::test)
...
{
    private const SDK_CLASS = 'PlacarAgoraSDK';
    ...
    private const SDK_BASE = 'placaragora_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../placaragora_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
